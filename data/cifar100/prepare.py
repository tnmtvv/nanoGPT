...
Usage:
    ...
    python data/cifar100/prepare.py --data_dir /path/to/cache --val_fraction 0.1
"""
import os
import json
import argparse
...
# 100 fine-label class names (alphabetical order as stored by torchvision)
CIFAR100_CLASSES = [
...
def main():
    parser = argparse.ArgumentParser(description="Prepare CIFAR-100 dataset")
    parser.add_argument(
        "--data_dir",
        type=str,
        default=os.path.dirname(os.path.abspath(__file__)),
        help="Directory where the raw dataset will be cached (default: data/cifar100/)",
    )
    parser.add_argument(
        "--val_fraction",
        type=float,
    ...
    # Download
    # ------------------------------------------------------------------
    print("[*] Downloading CIFAR-100 (if not already cached)...")
    ...
    # ------------------------------------------------------------------
    # Per-channel normalisation stats from training split only
    # ------------------------------------------------------------------
    ...
    print("[✓] CIFAR-100 preparation complete.")
